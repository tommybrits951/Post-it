    ...
    <section className="absolute w-full h-full">
      <div className="absolute w-1/2 bg-sky-300 top-20 rounded-xl shadow-xl left-1/4">
        ...
        <form
          ...
          className="text-center pt-3 bg-black mt-5"
        >
          <label className="text-white">
            First Name
            <br />
            <input
              className="bg-white w-3/4 text-black p-1 rounded"
              type="text"
              name="firstName"
          ...
          <div className="flex justify-around mt-5 p-5">
            <button
              className="text-white bg-gray-500 w-1/4 rounded-lg hover:scale-95 cursor-pointer p-2"
              onClick={() => clear()}
            >
              Clear
            </button>
            <button
              className="text-white bg-cyan-500 w-1/4 rounded-lg hover:scale-95 cursor-pointer p-2"
              value={"next"}
              onClick={pageHandle}
            >
              Next
