...
async function register(req, res) {
    try {
        ...
        return res
            .status(500)
            .json({ message: err.message || "Problem adding user." });
    }
}
...
async function getUsers(req, res) {
    try {
        ...
        return res
            .status(500)
            .json({ message: err.message || "Problem getting users." });
    }
}
...
async function getUserById(req, res) {
    try {
        ...
        return res
            .status(500)
            .json({ message: err.message || "Problem getting user." });
    }
}
